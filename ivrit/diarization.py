...
# Speechbrain-based diarization helper functions
def load_audio_speechbrain(mp3_path: str, target_sr: int = 16000):
...
def identify_speakers_with_optimization(mp3_path: str, segments: List[Segment],
    ...
    waveform, sample_rate = load_audio_speechbrain(mp3_path)
...
def diarize_ivrit(
    ...
    *,
    ...
    for i, segment in enumerate(transcription_segments):
        if i < len(best_results["segments"]):
